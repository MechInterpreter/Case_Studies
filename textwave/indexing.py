...
class FaissIndex:
    def __init__(self, index_type='brute_force', **kwargs):
        ...
        self.vector_dimension = 0  # Initialize vector_dimension
    ...
    def add_embeddings(self, new_vector, metadata=None):
        ...
        # Ensure new_vector is a numpy array
        ...
        # Print the shape of new_vector
        print(f"new_vector.shape: {new_vector.shape}")

        if self.vector_dimension == 0:
            self.vector_dimension = new_vector.shape[1]
            self.index = self._create_index()  # Create index on first addition
            print(f"Set self.vector_dimension to {self.vector_dimension}")
        else:
            print(f"self.vector_dimension: {self.vector_dimension}")
